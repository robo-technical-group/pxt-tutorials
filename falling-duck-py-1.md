...
1.  On an empty line in your code window, start typing the name of your variable, `hero_sprite`.
...
If a code snippet has included a **`pass`** statement, be sure to remove it when you add your own code.
